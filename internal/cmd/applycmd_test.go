...
func TestIssue4927(t *testing.T) {
	...
	chezmoitest.WithTestFS(t, map[string]any{
		...
		assert.NoError(t, fileSystem.WriteFile(
			"/home/user/.local/share/chezmoi/.chezmoiexternal.toml.tmpl",
			[]byte(chezmoitest.JoinLines(
				`[".file"]`,
				`    type = "file"`,
				`    url = "`+httpServer.URL+`/file"`,
		...
		assert.EqualError(
			...
			".file: .file: SHA256 mismatch: "+
				"expected 5ecfe762ad9a450cbc2317d8fd114d226ad97209ba1e11dc30ab26423a335fed, "+
				"got f1517c117381f6ac8c0b07e96152fe296891d9b56fb1ebc44ed0f8da2ab72688",
		)
		vfst.RunTests(t, fileSystem, ".file",
			vfst.TestPath("/home/user/.file",
				vfst.TestContentsString("contents of file, count 2\n"),
		...
		assert.EqualError(t,
			newTestConfig(t, fileSystem).execute([]string{"apply"}),
			".file: .file: SHA256 mismatch: expected "+
				"5ecfe762ad9a450cbc2317d8fd114d226ad97209ba1e11dc30ab26423a335fed, "+
				"got f1517c117381f6ac8c0b07e96152fe296891d9b56fb1ebc44ed0f8da2ab72688",
		)
		vfst.RunTests(t, fileSystem, ".file",
			vfst.TestPath("/home/user/.file",
		...
		assert.EqualError(t,
			...
			".file: .file: SHA256 mismatch: expected "+
				"5ecfe762ad9a450cbc2317d8fd114d226ad97209ba1e11dc30ab26423a335fed, "+
				"got 32da3f52b369ad56a60d0f9707268b5a8d0aba1839dde3fcfe6e3bf092777f97",
		)
		vfst.RunTests(t, fileSystem, ".file",
			vfst.TestPath("/home/user/.file",
				vfst.TestContentsString("contents of file, count 2\n"),
